...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.tests.questions.update', [$test, $question]) }}" class="stack">
            @csrf
            @method('PUT')

            <div class="field">
                <label for="question">Question</label>
                <textarea id="question" name="question">{{ old('question', $question->question) }}</textarea>
            </div>

            <div class="field-row">
                <div class="field">
                    <label for="option_a">Option A</label>
                    <input id="option_a" type="text" name="option_a" value="{{ old('option_a', $question->option_a) }}">
                </div>

                <div class="field">
                    <label for="option_b">Option B</label>
                    <input id="option_b" type="text" name="option_b" value="{{ old('option_b', $question->option_b) }}">
                </div>
            </div>
            ...
            <div class="field-row">
                <div class="field">
                    ...
                    <input id="option_c" type="text" name="option_c" value="{{ old('option_c', $question->option_c) }}">
                </div>

                <div class="field">
                    <label for="option_d">Option D</label>
                    <input id="option_d" type="text" name="option_d" value="{{ old('option_d', $question->option_d) }}">
                </div>
            </div>
